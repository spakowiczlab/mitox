...
I plugged in the percentile to view how many weeks will be needed to reach it.  I continued to return to this function and change the quantile based on what we decided for sample size.
...
ggsave("../figures/Fig2A_irAE-density.png", width = 4, height = 3)
...
outall %>%
  ...
  geom_line(aes(group = compliance, color = compliance)) +
  theme_bw() +
  geom_vline(aes(xintercept = 89), color = 'tan')
```
...
outall %>%
  ...
  ggsave("../figures/Fig2B_sample-size_trial-duration.png", width = 4, height = 3)
